...
Barang_5 = 5000
Barang_6 = 20000
LBarang = [Barang_1, Barang_2, Barang_3, Barang_4, Barang_5,  Barang_6]                    #LBarang     = ListBarang 
LNamaBarang = ["Barang_1","Barang_2","Barang_3","Barang_4","Barang_5","Barang_6"]          #LNamaBarang = ListNamaBarang
...
totalBarang = len(LBarang)                                                                 #Dalam kasus ini totalBarang = 6
